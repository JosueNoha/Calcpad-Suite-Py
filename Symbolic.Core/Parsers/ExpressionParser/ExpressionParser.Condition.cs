...
namespace Calcpad.Core
{
    public partial class ExpressionParser
    {
        ...
        private sealed class Condition
        {
            ...
            {
                // Longitudes para sintaxis MATLAB bare:
                //   if<space>      → 3
                //   while<space>   → 6
                //   elseif<space>  → 7
                //   else           → 4 (sin expresión)
                //   end            → 3 (cierra if; MATLAB usa "end" para if/for/function)
                return type switch
                {
                    Types.If => 3,
                    Types.Else => 4,
                    Types.While => 6,
                    Types.EndIf => 3,    // "end" bare MATLAB
                    Types.ElseIf => 7,   // "elseif " bare MATLAB
                    _ => 0,
                };
            }
